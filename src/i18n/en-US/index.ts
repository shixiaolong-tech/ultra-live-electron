export const resource = {
  ...
  // StreamCreate
  'streamCreate.createLive': 'Create Live',
  'streamCreate.liveTitle': 'Live Title',
  'streamCreate.category': 'Category',
  'streamCreate.contentTags': 'Content Tags',
  'streamCreate.cover': 'Cover',
  'streamCreate.coverHint': 'Recommended cover ratio 16:9, max 10MB',
  'streamCreate.liveControl': 'Live Control',
  'streamCreate.startLive': 'Start Live',
  'streamCreate.creating': 'Creating...',
  'streamCreate.selectCategory': 'Select category',
  'streamCreate.enterTitle': 'Enter live title',
