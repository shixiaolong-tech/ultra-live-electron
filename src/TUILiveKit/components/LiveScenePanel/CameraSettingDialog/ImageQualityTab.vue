<template>
  <!--
    Image quality (清晰度/锐化/对比度 …). Same per-item slider shape as the other
    intensity tabs; kept independent so the -100~100 ranged items can later get
    a dedicated layout without touching sibling tabs.
  -->
  <div class="image-quality-tab" :class="{ 'is-disabled': !enabled }">
