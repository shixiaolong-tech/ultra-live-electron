<template>
  <!--
    Advanced beauty / 美型 (大眼/瘦脸/窄脸 …). Per-item strength sliders gated by
    a group switch. Independent tab component sharing only the atoms.
  -->
  <div class="advanced-beauty-tab" :class="{ 'is-disabled': !enabled }">
...
const GROUP_KEY = 'advancedBeauty';
